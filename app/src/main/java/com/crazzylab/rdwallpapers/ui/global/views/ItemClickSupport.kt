...
/**
 * Created by Михаил on 27.09.2017.
 */
class ItemClickSupport(private val recyclerView: RecyclerView) {
    ...
    private fun setOnItemClickListener(listener: ItemClickListener): ItemClickSupport {
    ...
    private fun setOnItemLongClickListener(listener: ItemLongClickListener): ItemClickSupport {
    ...
    fun setOnItemLongClickListener(block: (RecyclerView, Int, View) -> Boolean): ItemClickSupport =
            setOnItemLongClickListener(object : ItemLongClickListener {
                override fun onLongClick(recyclerView: RecyclerView, position: Int, view: View): Boolean =
                        block (recyclerView, position, view)
            })
